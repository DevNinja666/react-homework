...
const CharacterCard: React.FC<CharacterCardProps> = ({ 
  ...
  return (
    <div
      className="group bg-gray-800 rounded-xl shadow-lg overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/30 border-2 border-gray-700 hover:border-green-500 active:scale-95"
      onClick={onCardClick}
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className={`text-sm px-2 py-1 rounded-full ${
            status === 'Alive' ? 'bg-green-500/20 text-green-400' :
            status === 'Dead' ? 'bg-red-500/20 text-red-400' :
